...
#define NO_pin 1
#define SO_pin 2
#define PIN_MISO_OPC 9
#define PIN_MOSI_OPC 10
#define PIN_SCK_OPC 8
#define PIN_CS_OPC 6

//SD card related definitions
#define PIN_MISO_SD 9
#define PIN_MOSI_SD 10
#define PIN_SCK_SD 8
#define PIN_CS_SD 7
...
void loop()
{
  if(timer_flag){
    ...
    if(intervalEval(MeasureInterval,currEpoch,prevEpochMeas,&prevEpochMeas)){
      ...
      sensorData.humidity = bme.hum();
      sensorData.temperature = bme.temp();
      //sensorData.pressure = bme.pres();
